...
<%@ page import="com.itlaobing.crm.workbench.domain.Tran" %>
<%@ page import="com.itlaobing.crm.settings.domain.DicValue" %>
...
* */
    ...
    for (int i = 0; i < stageList.size(); i++) {
        String possibility = pMap.get(stageList.get(i).getValue());
        //根据可能性来确定是否是交易失败的阶段
...
<div style="position: relative; left: 40px; top: -50px;">
    ...
    <%
        ...
        //如果当前阶段的可能性为0，说明为交易失败阶段，前7个全部为黑圈；后两个 一个红叉，一个黑叉
    ...
    <span id="<%=i%>" class="glyphicon glyphicon-remove mystage" data-toggle="popover" data-placement="bottom"
          data-content="<%=stageList.get(i).getText()%>" style="color: red;" onclick="changeStage('<%=listStage%>','<%=i%>')"></span>
    -----------
    <%
    } else {
        //-------黑叉
    %>
    <span id="<%=i%>" class="glyphicon glyphicon-remove mystage" data-toggle="popover" data-placement="bottom"
          data-content="<%=stageList.get(i).getText()%>" style="color: black;" onclick="changeStage('<%=listStage%>','<%=i%>')"></span>
    -----------
    <%
        }
        //遍历的可能性不为0，前7个阶段，黑圈
    ...
    <span id="<%=i%>" class="glyphicon glyphicon-map-marker mystage" data-toggle="popover" data-placement="bottom"
          data-content="<%=stageList.get(i).getText()%>" style="color: #90F790;" onclick="changeStage('<%=listStage%>','<%=i%>')"></span>
    -----------
    <%
...
<div style="position: relative; top: 0px;">
    ...
    <div style="position: relative; left: 40px; height: 30px; top: 60px;">
        ...
        <div style="width: 500px;position: relative; left: 200px; top: -20px;"><b>${tran.owner}&nbsp;&nbsp;</b><small
    ...
    <div style="position: relative; left: 40px; height: 30px; top: 70px;">
        ...
        <div style="width: 500px;position: relative; left: 200px; top: -20px;"><b  id="editBy">${tran.editBy}&nbsp;&nbsp;</b>
            <small style="font-size: 10px; color: gray;" id="editTime">${tran.editTime}</small></div>
        <div style="height: 1px; width: 550px; background: #D5D5D5; position: relative; top: -20px;"></div>
    </div>
